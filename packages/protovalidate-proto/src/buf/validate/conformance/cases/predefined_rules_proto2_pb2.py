...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['int32_abs_in_proto2']._serialized_options = b'\302Hc\na\n\023int32.abs_in.proto2\022!must be in absolute value of list\032\'this in rule || this in rule.map(n, -n)'
  _globals['int64_abs_in_proto2']._loaded_options = None
  _globals['int64_abs_in_proto2']._serialized_options = b'\302Hc\na\n\023int64.abs_in.proto2\022!must be in absolute value of list\032\'this in rule || this in rule.map(n, -n)'
