...
class ComplexTestMsg(_message.Message):
    ...
    def __init__(
        self,
        const: _Optional[str] = ...,
        nested: _Optional[_Union[ComplexTestMsg, _Mapping]] = ...,
        int_const: _Optional[int] = ...,
        bool_const: bool = ...,
        float_val: _Optional[_Union[_wrappers_pb2.FloatValue, _Mapping]] = ...,
        dur_val: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        ts_val: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...,
        another: _Optional[_Union[ComplexTestMsg, _Mapping]] = ...,
        float_const: _Optional[float] = ...,
        double_in: _Optional[float] = ...,
        enum_const: _Optional[_Union[ComplexTestEnum, str]] = ...,
        any_val: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...,
        rep_ts_val: _Optional[_Iterable[_Union[_timestamp_pb2.Timestamp, _Mapping]]] = ...,
        map_val: _Optional[_Mapping[int, str]] = ...,
