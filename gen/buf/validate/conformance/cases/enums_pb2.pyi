...
from buf.protovalidate.conformance.cases.yet_another_package import (
    embed2_pb2 as _embed2_pb2,
)
...
class EnumExternal(_message.Message):
    ...
    def __init__(
        self, val: _Optional[_Union[_embed_pb2.Embed.Enumerated, str]] = ...
    ) -> None: ...
...
class EnumExternal2(_message.Message):
    ...
    def __init__(
        self,
        val: _Optional[
            _Union[_embed_pb2.Embed.DoubleEmbed.DoubleEnumerated, str]
        ] = ...,
    ) -> None: ...
...
class RepeatedEnumDefined(_message.Message):
    ...
    def __init__(
        self, val: _Optional[_Iterable[_Union[TestEnum, str]]] = ...
    ) -> None: ...
...
class RepeatedExternalEnumDefined(_message.Message):
    ...
    def __init__(
        self, val: _Optional[_Iterable[_Union[_embed_pb2.Embed.Enumerated, str]]] = ...
    ) -> None: ...
...
class RepeatedYetAnotherExternalEnumDefined(_message.Message):
    ...
    def __init__(
        self, val: _Optional[_Iterable[_Union[_embed2_pb2.Embed.Enumerated, str]]] = ...
    ) -> None: ...
...
class MapEnumDefined(_message.Message):
    ...
    class ValEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[TestEnum, str]] = ...,
        ) -> None: ...
    VAL_FIELD_NUMBER: _ClassVar[int]
...
class MapExternalEnumDefined(_message.Message):
    ...
    class ValEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[_embed_pb2.Embed.Enumerated, str]] = ...,
        ) -> None: ...
    VAL_FIELD_NUMBER: _ClassVar[int]
    val: _containers.ScalarMap[str, _embed_pb2.Embed.Enumerated]
    def __init__(
        self, val: _Optional[_Mapping[str, _embed_pb2.Embed.Enumerated]] = ...
    ) -> None: ...
...
class EnumInsideOneof(_message.Message):
    ...
    def __init__(
        self,
        val: _Optional[_Union[TestEnum, str]] = ...,
        val2: _Optional[_Union[TestEnum, str]] = ...,
    ) -> None: ...
