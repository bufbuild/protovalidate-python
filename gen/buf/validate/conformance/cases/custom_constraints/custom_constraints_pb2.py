...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR,
    "buf.validate.conformance.cases.custom_constraints.custom_constraints_pb2",
    _globals,
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MISSINGFIELD._serialized_options = (
