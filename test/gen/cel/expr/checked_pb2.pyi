...
class CheckedExpr(_message.Message):
    ...
    def __init__(
        self,
        reference_map: _Optional[_Mapping[int, Reference]] = ...,
        type_map: _Optional[_Mapping[int, Type]] = ...,
        source_info: _Optional[_Union[_syntax_pb2.SourceInfo, _Mapping]] = ...,
        expr_version: _Optional[str] = ...,
        expr: _Optional[_Union[_syntax_pb2.Expr, _Mapping]] = ...,
    ) -> None: ...
...
class Type(_message.Message):
    ...
    class MapType(_message.Message):
        ...
        value_type: Type
        def __init__(
            self, key_type: _Optional[_Union[Type, _Mapping]] = ..., value_type: _Optional[_Union[Type, _Mapping]] = ...
        ) -> None: ...
    ...
    class FunctionType(_message.Message):
        ...
        def __init__(
            self,
            result_type: _Optional[_Union[Type, _Mapping]] = ...,
            arg_types: _Optional[_Iterable[_Union[Type, _Mapping]]] = ...,
        ) -> None: ...
    ...
    class AbstractType(_message.Message):
        ...
        def __init__(
            self, name: _Optional[str] = ..., parameter_types: _Optional[_Iterable[_Union[Type, _Mapping]]] = ...
        ) -> None: ...
    ...
    def __init__(
        self,
        dyn: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ...,
        null: _Optional[_Union[_struct_pb2.NullValue, str]] = ...,
        primitive: _Optional[_Union[Type.PrimitiveType, str]] = ...,
        wrapper: _Optional[_Union[Type.PrimitiveType, str]] = ...,
        well_known: _Optional[_Union[Type.WellKnownType, str]] = ...,
        list_type: _Optional[_Union[Type.ListType, _Mapping]] = ...,
        map_type: _Optional[_Union[Type.MapType, _Mapping]] = ...,
        function: _Optional[_Union[Type.FunctionType, _Mapping]] = ...,
        message_type: _Optional[str] = ...,
        type_param: _Optional[str] = ...,
        type: _Optional[_Union[Type, _Mapping]] = ...,
        error: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ...,
        abstract_type: _Optional[_Union[Type.AbstractType, _Mapping]] = ...,
    ) -> None: ...
...
class Decl(_message.Message):
    ...
    class IdentDecl(_message.Message):
        ...
        def __init__(
            self,
            type: _Optional[_Union[Type, _Mapping]] = ...,
            value: _Optional[_Union[_syntax_pb2.Constant, _Mapping]] = ...,
            doc: _Optional[str] = ...,
        ) -> None: ...
    ...
    class FunctionDecl(_message.Message):
        ...
        class Overload(_message.Message):
            ...
            def __init__(
                self,
                overload_id: _Optional[str] = ...,
                params: _Optional[_Iterable[_Union[Type, _Mapping]]] = ...,
                type_params: _Optional[_Iterable[str]] = ...,
                result_type: _Optional[_Union[Type, _Mapping]] = ...,
                is_instance_function: bool = ...,
                doc: _Optional[str] = ...,
            ) -> None: ...
        ...
        def __init__(
            self,
            overloads: _Optional[_Iterable[_Union[Decl.FunctionDecl.Overload, _Mapping]]] = ...,
            doc: _Optional[str] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        ident: _Optional[_Union[Decl.IdentDecl, _Mapping]] = ...,
        function: _Optional[_Union[Decl.FunctionDecl, _Mapping]] = ...,
    ) -> None: ...
...
class Reference(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        overload_id: _Optional[_Iterable[str]] = ...,
        value: _Optional[_Union[_syntax_pb2.Constant, _Mapping]] = ...,
    ) -> None: ...
