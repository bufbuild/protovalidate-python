...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "buf.validate.conformance.cases.messages_pb2", _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _TESTMSG.fields_by_name["const"]._options = None
    _TESTMSG.fields_by_name[
        "const"
    ]._serialized_options = b"\372\367\030\007r\005\n\003foo"
    _MESSAGEDISABLED.fields_by_name["val"]._options = None
    _MESSAGEDISABLED.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\0042\002 {"
    ...
    _MESSAGESKIP.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\003\300\001\001"
    _MESSAGEREQUIRED.fields_by_name["val"]._options = None
    _MESSAGEREQUIRED.fields_by_name[
        "val"
