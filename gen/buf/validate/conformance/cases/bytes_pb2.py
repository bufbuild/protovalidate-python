...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "buf.validate.conformance.cases.bytes_pb2", _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _BYTESCONST.fields_by_name["val"]._options = None
    _BYTESCONST.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\007z\005\n\003foo"
    _BYTESIN.fields_by_name["val"]._options = None
    _BYTESIN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\014z\nB\003barB\003baz"
    _BYTESNOTIN.fields_by_name["val"]._options = None
    _BYTESNOTIN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\016z\014J\004fizzJ\004buzz"
    ...
    _BYTESMINLEN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\004z\002\020\003"
    _BYTESMAXLEN.fields_by_name["val"]._options = None
    _BYTESMAXLEN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\004z\002\030\005"
    _BYTESMINMAXLEN.fields_by_name["val"]._options = None
    _BYTESMINMAXLEN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\006z\004\020\003\030\005"
    _BYTESEQUALMINMAXLEN.fields_by_name["val"]._options = None
    _BYTESEQUALMINMAXLEN.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\006z\004\020\005\030\005"
    _BYTESPATTERN.fields_by_name["val"]._options = None
    _BYTESPATTERN.fields_by_name[
        "val"
    ]._serialized_options = b'\372\367\030\022z\020"\016^[\\x00-\\x7F]+$'
    _BYTESPREFIX.fields_by_name["val"]._options = None
    _BYTESPREFIX.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\005z\003*\001\231"
    _BYTESCONTAINS.fields_by_name["val"]._options = None
    _BYTESCONTAINS.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\007z\005:\003bar"
    _BYTESSUFFIX.fields_by_name["val"]._options = None
    _BYTESSUFFIX.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\010z\0062\004buzz"
    ...
    _BYTESIPV6IGNORE.fields_by_name[
        "val"
    ]._serialized_options = b"\372\367\030\007z\002`\001\320\001\001"
