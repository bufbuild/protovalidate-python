...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_REQUIREDPROTO3MAPKEY_VALENTRY']._loaded_options = None
  _globals['_REQUIREDPROTO3MAPKEY_VALENTRY']._serialized_options = b'8\001'
  _globals['_REQUIREDPROTO3MAPKEY'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDPROTO3MAPKEY'].fields_by_name['val']._serialized_options = b'\272H\010\232\001\005\"\003\310\001\001'
  _globals['_REQUIREDPROTO3MAPVALUE_VALENTRY']._loaded_options = None
  _globals['_REQUIREDPROTO3MAPVALUE_VALENTRY']._serialized_options = b'8\001'
  _globals['_REQUIREDPROTO3MAPVALUE'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDPROTO3MAPVALUE'].fields_by_name['val']._serialized_options = b'\272H\010\232\001\005*\003\310\001\001'
  _globals['_REQUIREDPROTO3REPEATEDITEM'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDPROTO3REPEATEDITEM'].fields_by_name['val']._serialized_options = b'\272H\010\222\001\005\"\003\310\001\001'
  _globals['_REQUIREDIMPLICITPROTO3SCALAR'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDIMPLICITPROTO3SCALAR'].fields_by_name['val']._serialized_options = b'\272H\tr\004\020\001\030\002\310\001\001'
  _globals['_REQUIREDIMPLICITPROTO3REPEATED'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDIMPLICITPROTO3REPEATED'].fields_by_name['val']._serialized_options = b'\272H\n\222\001\004\010\001\020\002\310\001\001'
  _globals['_REQUIREDIMPLICITPROTO3MAP_VALENTRY']._loaded_options = None
  _globals['_REQUIREDIMPLICITPROTO3MAP_VALENTRY']._serialized_options = b'8\001'
  _globals['_REQUIREDIMPLICITPROTO3MAP'].fields_by_name['val']._loaded_options = None
  _globals['_REQUIREDIMPLICITPROTO3MAP'].fields_by_name['val']._serialized_options = b'\272H\n\232\001\004\010\001\020\002\310\001\001'
  ...
  _globals['_REQUIREDPROTO3MAPKEY']._serialized_start=1324
  _globals['_REQUIREDPROTO3MAPKEY']._serialized_end=1496
  _globals['_REQUIREDPROTO3MAPKEY_VALENTRY']._serialized_start=1076
  _globals['_REQUIREDPROTO3MAPKEY_VALENTRY']._serialized_end=1130
  _globals['_REQUIREDPROTO3MAPVALUE']._serialized_start=1499
  _globals['_REQUIREDPROTO3MAPVALUE']._serialized_end=1675
  _globals['_REQUIREDPROTO3MAPVALUE_VALENTRY']._serialized_start=1076
  _globals['_REQUIREDPROTO3MAPVALUE_VALENTRY']._serialized_end=1130
  _globals['_REQUIREDPROTO3REPEATEDITEM']._serialized_start=1677
  _globals['_REQUIREDPROTO3REPEATEDITEM']._serialized_end=1736
  _globals['_REQUIREDIMPLICITPROTO3SCALAR']._serialized_start=1738
  _globals['_REQUIREDIMPLICITPROTO3SCALAR']._serialized_end=1800
  _globals['_REQUIREDIMPLICITPROTO3REPEATED']._serialized_start=1802
  _globals['_REQUIREDIMPLICITPROTO3REPEATED']._serialized_end=1867
  _globals['_REQUIREDIMPLICITPROTO3MAP']._serialized_start=1870
  _globals['_REQUIREDIMPLICITPROTO3MAP']._serialized_end=2054
  _globals['_REQUIREDIMPLICITPROTO3MAP_VALENTRY']._serialized_start=1076
  _globals['_REQUIREDIMPLICITPROTO3MAP_VALENTRY']._serialized_end=1130
