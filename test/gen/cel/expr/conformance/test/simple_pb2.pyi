...
class SimpleTestFile(_message.Message):
    ...
    def __init__(
        ...
        section: _Optional[_Iterable[_Union[SimpleTestSection, _Mapping]]] = ...,
    ) -> None: ...
...
class SimpleTestSection(_message.Message):
    ...
    def __init__(
        ...
        name: _Optional[str] = ...,
        description: _Optional[str] = ...,
        test: _Optional[_Iterable[_Union[SimpleTest, _Mapping]]] = ...,
    ) -> None: ...
...
class SimpleTest(_message.Message):
    ...
    def __init__(
        ...
        typed_result: _Optional[_Union[TypedResult, _Mapping]] = ...,
        eval_error: _Optional[_Union[_eval_pb2.ErrorSet, _Mapping]] = ...,
        any_eval_errors: _Optional[_Union[ErrorSetMatcher, _Mapping]] = ...,
        unknown: _Optional[_Union[_eval_pb2.UnknownSet, _Mapping]] = ...,
        any_unknowns: _Optional[_Union[UnknownSetMatcher, _Mapping]] = ...,
    ) -> None: ...
...
class TypedResult(_message.Message):
    ...
    def __init__(
        self,
        result: _Optional[_Union[_value_pb2.Value, _Mapping]] = ...,
